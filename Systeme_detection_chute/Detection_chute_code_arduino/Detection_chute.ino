#include <M5Unified.h>
#include <WiFi.h>
#include <WiFiClientSecure.h> // 🚨 LIGNE 3 AJOUTÉE
...
// ==========================================
const char* ssid      = "S24 Djo98";
const char* password  = "Djolinux98@";
const char* mqtt_host = "88ffea9693414c70bc1633c79ad57a2d.s1.eu.hivemq.cloud";
const char* mqtt_user = "Mecavenir";       // 🚨 LIGNE 18 AJOUTÉE (Mets ton vrai User HiveMQ)
const char* mqtt_pass = "Mecavenir1"; // 🚨 LIGNE 19 AJOUTÉE (Mets ton vrai Mdp HiveMQ)
...
WiFiClientSecure espClient; // 🚨 LIGNE 26 MODIFIÉE (WiFiClientSecure au lieu de WiFiClient)
...
void setup_wifi() {
  ...
  espClient.setInsecure(); // 🚨 LIGNE 344 AJOUTÉE (Obligatoire pour le SSL HiveMQ)
}

void reconnect_mqtt() {
  if (!client.connected()) {
    // 🚨 LIGNE 350 MODIFIÉE (Ajout de mqtt_user et mqtt_pass)
